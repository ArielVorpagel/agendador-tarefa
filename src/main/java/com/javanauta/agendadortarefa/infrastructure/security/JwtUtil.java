...
public class JwtUtil {
    ...
    // Extrai o nome(email e dados) de usuário do token JWT
    ...
    // Valida o token JWT verificando o nome (utilizado para Email também)de usuário e se o token não está expirado
